...
def wavwrite(snd,Fs,sndfile):
   "This function implements the wawwritefunction of Octave or Matlab to write a wav sound file from a vector s with sampling rate Fs at, with: import sound; sound.wavwrite('sound.wav',Fs);"
